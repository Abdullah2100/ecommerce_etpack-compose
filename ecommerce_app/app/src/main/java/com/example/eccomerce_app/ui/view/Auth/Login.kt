...
import com.example.common.model.LoginScreenDataHolder
...
fun LoginScreen(
    ...
    { contentPadding ->
        ...
        )
        {
            ...
            Sizer(heigh = 50)
            TextInputWithTitle(
                onChange = {value-> state.userNameOrEmail.value = TextFieldValue(value)},
            ...
            CustomAuthBottom(
                ...
                validationFun = {
                    isValidateInput(state.userNameOrEmail.value.text, state.password.value.text)
                })
