...
class StoreRepository(private val client: HttpClient, private val authDao: AuthDao) {
    ...
    suspend fun getStoreById(id: UUID): NetworkCallHandler = withContext(Dispatchers.IO) {
        val authData =
            getAuthData() ?: return@withContext NetworkCallHandler.Error("user is not authenticate ")
